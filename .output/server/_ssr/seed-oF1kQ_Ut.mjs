//#region node_modules/.nitro/vite/services/ssr/assets/seed-oF1kQ_Ut.js
var V = (name) => `https://storage.googleapis.com/gtv-videos-bucket/sample/${name}.mp4`;
var CURRENT_USER_ID = "u-alex";
var creators = [
	{
		id: "u-alex",
		username: "you",
...
var now = Date.UTC(2026, 7, 27, 12, 0, 0);
var minutesAgo = (m) => (/* @__PURE__ */ new Date(now - m * 6e4)).toISOString();
var stories = [
	[
		"u-maya",
		"story/maya-golden",
...
var externalPosts = [{
	...
	caption: "Shipped the new discovery grid today. Masonry with mixed aspect ratios reads far better than a uniform grid — the eye actually has somewhere to travel.",
	media: [{
		kind: "image",
...
var news = [
	{
		...
		summary: "Lean teams are shipping discovery products that once needed hundreds of engineers, and audiences are following them.",
...
].map(([id, authorId, caption, soundtrack, category, url, likes]) => ({
	id,
	authorId,
	caption,
	soundtrack,
...
var videos = [
	[
		"v-1",
		"u-riko",
		"Making Neon Rain — full studio walkthrough",
		"Music",
		V("ForBiggerBlazes"),
		212e3,
		"1 week ago",
	...
	[
		"v-2",
		"u-leo",
		"Iceland ring road in 8 minutes",
		"Travel",
		V("ForBiggerJoyrides"),
		12e5,
		"3 weeks ago",
	...
	[
		"v-3",
		"u-june",
		"The only knife skills tutorial you need",
		"Food",
		V("ForBiggerFun"),
		54e4,
		"1 month ago"
	...
	[
		"v-4",
		"u-nina",
		"Design system tour — building BUZZ",
		"Tech",
		V("ForBiggerEscapes"),
		38e3,
		"4 days ago"
...
].map(([id, authorId, title, category, url, views, publishedAt, progress]) => ({
	id,
	authorId,
	title,
	category,
...
//#endregion
export { news as a, shorts as c, videos as d, externalPosts as i, stories as l, creators as n, notifications as o, explorePhotos as r, posts as s, CURRENT_USER_ID as t, trending as u };
